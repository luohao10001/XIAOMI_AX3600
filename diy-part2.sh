...
git clone https://github.com/Boos4721/OpenWrt-Packages.git package/luci-app-eqos
git clone https://github.com/Boos4721/OpenWrt-Packages.git package/luci-app-advanced
